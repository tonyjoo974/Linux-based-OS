...
volatile int screen_x; // next x position to write to
volatile int screen_y; // next y position to write to
volatile unsigned char kbd_buffer[BUF_SIZE];
volatile uint32_t buffer_idx; // index in kbd_buffer
volatile uint8_t saved_kbd_buffer[BUF_SIZE]; // previous state of kbd_buffer
